/*
	Function: anomaly_fnc_activateSmuggler
	Description:
...
if(_trg getVariable ["anomaly_type",""] != "smuggler") exitWith {};
...
if(hasInterface) then {
	[_proxy2, _source, "active"] call anomalyEffect_fnc_smuggler;
	[_proxy3, _source2, "active"] call anomalyEffect_fnc_smuggler;
