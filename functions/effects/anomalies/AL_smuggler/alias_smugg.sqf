...
_sursa_smugg = createVehicle ["Sign_Sphere200cm_F", [getmarkerpos _marker_sursa_smugg select 0,getmarkerpos _marker_sursa_smugg select 1,2], [], 0, "CAN_COLLIDE"];
_sursa_smugg_core = createVehicle ["Sign_Sphere100cm_F", [getmarkerpos _marker_sursa_smugg select 0,getmarkerpos _marker_sursa_smugg select 1,2], [], 0, "CAN_COLLIDE"];
_sursa_smugg_core setObjectMaterial [0,"A3\Structures_F\Data\Windows\window_set.rvmat"];
_sursa_smugg setObjectMaterial [0,"A3\Structures_F\Data\Windows\window_set.rvmat"];
_sursa_smugg setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0.3,ca)"];
_sursa_smugg_core setObjectTextureGlobal [0, "#(argb,8,8,3)color(0,0,0,0.7,ca)"];
...
[[_sursa_smugg],"AL_smuggler\teleport_smugg.sqf"] remoteExec ["execVM",0,true];
